...
myManageHook = composeAll . concat $
    ...
    , [(className =? x <||> title =? x <||> resource =? x) --> doShiftAndGo "0" | x <- my10Shifts]
    ]
    where
    doShiftAndGo = doF . liftM2 (.) W.greedyView W.shift
    myCFloats = ["Arcolinux-tweak-tool.py", "Pavucontrol", "stacer"]
...
myKeys conf@(XConfig {XMonad.modMask = modMask}) = M.fromList $
  ...
  , ((modMask, xK_m), spawn $ "pavucontrol" )
  , ((modMask, xK_t), spawn $ "ytop" )
  , ((modMask, xK_s), spawn $ "subl" )
  , ((modMask, xK_Return), spawn $ "alacritty" )
  , ((modMask, xK_c), spawn $ "discord" )
  , ((modMask, xK_x), spawn $ "arcolinux-logout" )
  , ((modMask, xK_i), spawn $ "xfce4-settings-manager" )
  , ((modMask, xK_d), spawn $ "rofi -no-lazy-grab -show drun -theme ~/.config/rofi/launcher.rasi" )
  , ((modMask, xK_h), spawn $ "stacer" )
  ...
  , ((modMask .|. shiftMask , xK_d ), spawn $ "dmenu_run -i -nb '#2F343F' -nf '#3384d0' -sb '#3384d0' -sf '#2F343F' -fn 'IosevkaRegular:pixelsize=17'")
  , ((modMask .|. shiftMask , xK_r ), spawn $ "xmonad --recompile && xmonad --restart")
  , ((modMask .|. shiftMask , xK_q ), kill)
  , ((modMask .|. shiftMask , xK_w ), spawn $ "nitrogen")
  ...
  , ((modMask, xK_Print), spawn $ "flameshot full -c -p ~/Pictures/Screenshots" )
  , ((controlMask, xK_Print ), spawn $ "flameshot gui -c")
  , ((modMask .|. controlMask, xK_Print ), spawn $ "flameshot gui -c -p ~/Pictures/Screenshots")
